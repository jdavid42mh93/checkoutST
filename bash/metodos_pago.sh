...
store_code='Carniletto cajica'

echo "\n Obteniendo metodos de pago \n"
curl --location --request GET "https://payment.getduna.com:443/api/v1/transactions/payments-methods?available_option=pickup" \
--header "Authorization: Bearer ${token}" \
--header "X-Merchant-Id: ${merchant_id}" \
--header "X-Store-Code: ${store_code}" \ | json_pp -json_opt pretty,canonical
